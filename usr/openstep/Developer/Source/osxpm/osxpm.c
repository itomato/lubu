 ...
 ****************************************************************************/
/****************************************************************************
 * This is a hacked version of xpmroot used to run independent of fvwm,
 * as the only source for xpmroot I could find was in the fvwm-2.0.42 build.
 * This version is (C)2006 Luke Th. Bullock for LuBu OpenMagic 1.0
 ****************************************************************************/
...
int main(int argc, char **argv)
{
  ...
  if(argc != 2)
    {
      fprintf(stderr,"OSXPM Version %s\n",VERSION);
      fprintf(stderr,"Usage: osxpm xpmfile\n");
/*      fprintf(stderr,"Try Again\n"); */
  ...
  if (!dpy) 
    {
      fprintf(stderr, "osxpm:  unable to open display '%s'\n",
